...
def parse_opt():
    ...
    parser.add_argument('--val_id', type=str, default='1601',
    ...
    parser.add_argument('--checkpoint_path', type=str, default='save_pre_1601',
    ...
    # misc
    parser.add_argument('--id', type=str, default='1601',
