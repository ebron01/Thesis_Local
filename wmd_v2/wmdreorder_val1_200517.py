...
print('Loading model')
model= KeyedVectors.load_word2vec_format('/data/wmd/GoogleNews-vectors-negative300.bin', binary=True)
start_embeddings = datetime.now()
print('Loaded model')
print('cell started at : ' + str(start_embeddings))
...
query = '../turi/10closest_updated_query_mid_new_val1.json'
...
sorted_filename = 'sorted_10closest_updated_query_mid_new_val1.json'
