...
def parse_opt():
    ...
    parser.add_argument('--val_id', type=str, default='attent_visualized_Hybrid_scratch_02_hypersearch',
    ...
    parser.add_argument('--checkpoint_path', type=str, default='/home/luchy/Desktop/results/attent_visualized_Hybrid_scratch_02_hypersearch',
    ...
    # misc
    parser.add_argument('--id', type=str, default='attent_visualized_Hybrid_scratch_02_hypersearch',
