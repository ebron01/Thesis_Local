...
def parse_opt():
    ...
    parser.add_argument('--val_id', type=str, default='result_concat_dict',
    ...
    parser.add_argument('--checkpoint_path', type=str, default='/home/luchy/Desktop/results/result_concat_dict',
    ...
    # misc
    parser.add_argument('--id', type=str, default='result_concat_dict',
