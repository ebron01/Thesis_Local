...
def parse_opt():
    ...
    parser.add_argument('--val_id', type=str, default='result_concat_aux_attent_encoder',
    ...
    parser.add_argument('--checkpoint_path', type=str, default='/home/luchy/Desktop/results/result_concat_aux_attent_encoder',
    ...
    # misc
    parser.add_argument('--id', type=str, default='result_concat_aux_attent_encoder',
