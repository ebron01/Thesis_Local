...
def parse_opt():
    ...
    parser.add_argument('--val_id', type=str, default='result_base_missing_wo_gt_full_sent',
    ...
    parser.add_argument('--checkpoint_path', type=str, default='/home/luchy/Desktop/results/result_base_missing_wo_gt_full_sent',
    ...
    # misc
    parser.add_argument('--id', type=str, default='result_base_missing_wo_gt_full_sent',
