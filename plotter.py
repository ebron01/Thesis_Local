...
for key in file_dirs:
    for file in file_dirs[key]:
        ...
        for e in d_epoch:
            ...
            for key in sorted(histories['d_loss_history'].keys()):
                if histories['d_loss_history'][key]['d_epoch'] == e:
                    ...
                    dis_s_loss_.append(histories['d_loss_history'][key]['dis_s_loss'])
            ...
            dis_s_loss.update({e: dis_s_loss_})
        ...
        d_s_loss_epoch_plot = []
        for key in dis_v_loss_epoch.keys():
            d_s_loss_epoch_plot.append(dis_s_loss_epoch[key])
        ...
        d_for_t_s = range(len(d_s_loss_epoch_plot))
        # plt.plot(iter, iter_loss, '-b', label='g_loss')
        ...
        plt.plot(d_for_t_s, d_s_loss_epoch_plot, '-m', label='dis_t_s_loss')
