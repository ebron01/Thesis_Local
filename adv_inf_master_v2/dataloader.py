...
class DataLoader(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        self.aux_ix.update({'v__0gvD2pktxxw_1': self.aux_ix['v_8K4cX9GfaII_2']})
        self.aux_ix.update({'v__0gvD2pktxxw_2': self.aux_ix['v_8K4cX9GfaII_2']})
        self.aux_ix.update({'v__0gvD2pktxxw_3': self.aux_ix['v_8K4cX9GfaII_2']})
