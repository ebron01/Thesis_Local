...
def parse_opt():
    ...
    parser.add_argument('--val_id', type=str, default='result_base_repro',
    ...
    parser.add_argument('--checkpoint_path', type=str, default='/home/luchy/Desktop/results/result_base_repro',
    ...
    # misc
    parser.add_argument('--id', type=str, default='result_base_repro',
